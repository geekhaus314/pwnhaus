/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers\site-backend\wrangler.jsonc workers\site-backend\worker-configuration.d.ts` (hash: 478956acae04fc96f10913f0767409a7)
