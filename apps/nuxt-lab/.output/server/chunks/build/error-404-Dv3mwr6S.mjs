...
import { q as hasProtocol, l as joinURL, p as parseQuery, A as isScriptProtocol, B as withTrailingSlash, C as withoutTrailingSlash } from '../_/nitro.mjs';
...
var _sfc_main = {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(`<div${ssrRenderAttrs(mergeProps({ class: "antialiased bg-white dark:bg-[#020420] dark:text-white font-sans grid min-h-screen overflow-hidden place-content-center text-[#020420] tracking-wide" }, _attrs))} data-v-7f9a02ac><div class="max-w-520px text-center" data-v-7f9a02ac><h1 class="font-semibold leading-none mb-4 sm:text-[110px] tabular-nums text-[80px]" data-v-7f9a02ac>${ssrInterpolate(__props.status)}</h1><h2 class="font-semibold mb-2 sm:text-3xl text-2xl" data-v-7f9a02ac>${ssrInterpolate(__props.statusText)}</h2><p class="mb-4 px-2 text-[#64748B] text-md" data-v-7f9a02ac>${ssrInterpolate(__props.description)}</p><div class="flex items-center justify-center w-full" data-v-7f9a02ac>`);
...
var error_404_default = /*#__PURE__*/ _plugin_vue_export_helper_default(_sfc_main, [["__scopeId", "data-v-7f9a02ac"]]);

export { error_404_default as default };
//# sourceMappingURL=error-404-Dv3mwr6S.mjs.map
